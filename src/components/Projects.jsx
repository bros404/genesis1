...
const Projects = ({ projects }) => {
  ...
  return (
    <div className="flex flex-col px-6 mb-7">
      <div className="absolute top-10 left-1/2 w-[60rem] -translate-x-1/2  pointer-events-none ">
          <img
            src={stars}
            className="w-full"
            width={950}
...
const ProjectCard = ({ project }) => {
  ...
  return (
   <div className="rounded-lg shadow-lg bg-gradient-to-b from-violet-500 via-blue-800 to-slate-900 p-1 w-64 m-4">
      <div id="projects" className="rounded-lg shadow-lg bg-slate-900 p-0 w-63.5 m-0">
